...
import RadialGrid from './grid.jsx'
...
let even = evenGrid(0, 0, 12, .5, function(n) {
  let i = 0;
  let k = 1;  
...
let odd = evenGrid(0, 0, 16, .5, function(n) {
  let i = 0;
  let k = 1;  
...
const testPage = () => (
  <>
    ...
    <svg height="750" width="750" viewBox="-15 -15 30 30">{ odd }</svg>
    <svg height="750" width="750" viewBox="-12 -12 24 24">{ even }</svg>
